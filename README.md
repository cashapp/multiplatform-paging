...
For example, if AndroidX Paging is on `3.1.1` and Multiplatform Paging is on `0.3.1`,
the artifact for a release of `paging-common` will be `app.cash.paging:paging-common:3.1.1-0.3.1`.
...
```kotlin
implementation("app.cash.paging:paging-runtime-uikit:3.1.1-0.3.1")
```
