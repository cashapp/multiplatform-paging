    ...
    fun calculateDiff(cb: Callback, detectMoves: Boolean): DiffResult {
        ...
        while (!stack.isEmpty()) {
            ...
            if (snake != null) {
                ...
                val left: Range = if (rangePool.isEmpty()) {
                    Range()
                } else {
        ...
        return DiffResult(cb, diagonals,
                ...
                while (posY < diagonal.y) {
                    ...
                    if (mNewItemStatuses[posY] == 0) { // not evaluated yet
                        ...
                        if (matching) {
                            ...
                            val changeFlag: Int = if (contentsMatching) {
            ...
            while (diagonalIndex >= 0) {
                ...
                while (posX > endX) {
                    ...
                    if ((status and FLAG_MOVED) != 0) {
                        ...
                        if (postponedUpdate != null) {
                            ...
                            postponedUpdates.add(PostponedUpdate(
                                    posX,
                ...
                while (posY > endY) {
                    ...
                    if ((status and FLAG_MOVED) != 0) {
                        ...
                        val postponedUpdate: PostponedUpdate? = getPostponedUpdate(postponedUpdates,
                                oldPos, true)
