 ...
 */
public class BatchingListUpdateCallback(callback: ListUpdateCallback) : ListUpdateCallback {
    ...
    public override fun onRemoved(position: Int, count: Int) {
